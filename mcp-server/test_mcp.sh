...
echo '{"jsonrpc": "2.0", "id": 15, "method": "tools/call", "params": {"name": "search_products", "arguments": {"category": "", "maxPrice": "", "offset": 0, "limit": 10}}}' | ./dist/mcp-server | jq

echo '{"jsonrpc": "2.0", "id": 17, "method": "tools/call", "params": {"name": "get_items", "arguments": {}}}' | ./dist/mcp-server
