...
// 			{Code: "P001", Price: decimal.NewFromInt(100)},
// 			{Code: "P002", Price: decimal.NewFromInt(20)},
// 		}
...
// 			Items: []models.Item{
// 				{Name: "Variant1", SKU: "SKU001", Price: decimal.NewFromInt(90)},
// 				{Name: "Variant2", SKU: "SKU002", Price: decimal.NewFromInt(80)},
// 			},
// 		}

// 		// Mock the GetProductByCode method to return a sample product
// 		repo.EXPECT().GetProductByCode("P001").Return(prod, nil)
...
// 		expected := mapToProductResponse(prod)
...
// 		repo.EXPECT().GetProductByCode("P001").Return(nil, errors.New("product not found"))
...
// 		repo.EXPECT().GetProductByCode("P001").Return(nil, nil)
